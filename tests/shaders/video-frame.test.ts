...
import { videoFrameShader } from '../../src/shaders';
import {
  createTestContext,
  createTestTexture,
...
describe('Video Frame Shader', () => {
  ...
  it('should render video frame correctly in WebGL2', async () => {
    ...
    gl.shaderSource(vertexShader, videoFrameShader.webgl2.vertex);
    gl.shaderSource(fragmentShader, videoFrameShader.webgl2.fragment);
    ...
    expect(compareFramebuffers(pixels, testData, 1)).toBe(true);
  });

  it('should render video frame correctly in WebGPU', async () => {
